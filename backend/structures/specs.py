...
STRUCTURES: dict[str, dict] = {
    "S1": {
        "name": "Classic",
        "audience": "3+ years experience (default)",
    ...
    "S2": {
        "name": "Tech projects-forward",
        "audience": "developers with strong side projects",
    ...
    "S4": {
        "name": "Career-changer hybrid",
        "audience": "switching fields; never functional/undated",
